           ...
           <div class="panel-body">
               <form method="post" class="form-horizontal" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-md-6">
                      <input name="pass_user" type="password" class="form-control">
                      </div>
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                       ...
                       <div class="col-md-6">
                           <input name="img_user" type="file" class="form-control">
...
if(isset($_POST['update'])){
    ...
    $user_pass = $_POST['pass_user'] ? password_hash($_POST['pass_user'], PASSWORD_DEFAULT) : $user_pass; // Encripta si hay nueva contraseña
    ...
    if(!empty($img_user)){
        ...
        $img_user = $user_image; // Si no se sube nueva imagen, mantener la actual
    }
