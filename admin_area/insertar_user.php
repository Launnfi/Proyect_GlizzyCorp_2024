        ...
        <div class="panel panel-default">
           ...
           <div class="panel-body">
               <form method="post" class="form-horizontal" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                      <label class="col-md-3 control-label"> Información </label> 
                      <div class="col-md-6">
...
if(isset($_POST['submit'])){
    ...
    $insert_adm = "insert into admin (admin_nombre,admin_email,admin_pass,admin_img,admin_ciudad,admin_sobre,admin_contacto,admin_trabajo) values ('$nom_user','$email_user','$hashed_pass','$img_user','$ciud_user','$user_info','$con_user','$trab_user')";
